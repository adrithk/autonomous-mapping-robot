...
- [ ] Three room photo/map pairs, including original YAML + occupancy images and readable previews.
...
After the final repeatable run, replace the README status and TBD cells with measured
